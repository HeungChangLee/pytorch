# SqueezeNet fitted CIFAR-10 dataset by Pytorch
import numpy as np
import torch
...
class Fire_Module(nn.Module):
    def __init__(self, input_dim, squeeze_dim, expand1x1_dim, expand3x3_dim):
        ...
        self.squeeze_layer = nn.Sequential(
            ...
            nn.BatchNorm2d(squeeze_dim), #add BatchNorm term after Conv_layer # Because we didn't get good result without BatchNorm term in CIFAR-10 dataset
            nn.ReLU())
...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes):
        ...
        self.squeezenet = nn.Sequential(
            ...
            nn.Conv2d(3, 96, kernel_size = 3, stride = 1, padding = 1), #conv1 #For CIFAR-10 images which are 32x32 size.
            nn.BatchNorm2d(96),
            nn.ReLU(),
            ...
            nn.ReLU(),
            nn.AvgPool2d(4, stride = 1) #For CIFAR-10 images which are 32x32 size.
        )
        for m in self.modules():
            weight_init(m)
